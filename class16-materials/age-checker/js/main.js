...
// let age = 27;
function conditionalCheck(age){
if (age < 16) {
    console.log("you can not drive")
} else if (age < 18) {
    console.log("you can't hate from outside the club, because you cant even get in.")
} else if (age < 21) {
...
//--- Harder
//On click of the h1
let h1_val = document.querySelector('h1')
//Take the value from the input
h1_val.addEventListener('click', result)

//Place the result of the conditional in the paragraph
function result() {
    let age = document.querySelector('#danceDanceRevolution').value

    conditionalCheck(age)
}